...
public class ZombieDTO {
    ...
    public ZombieDTO(Long id_zombie, String nom, Integer point_de_vie, BigDecimal attaque_par_seconde,
                     Integer degat_attaque, BigDecimal vitesse_de_deplacement, String chemin_image,
                     Long id_map) {
